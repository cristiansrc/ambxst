...
WlSessionLockSurface {
    ...
    TintedWallpaper {
        ...
        function updateWallpaperPath() {
            ...
            lockscreenFramePath = GlobalStates.wallpaperManager.getLockscreenFramePath(baseWall);
        }

        source: lockscreenFramePath ? "file://" + lockscreenFramePath + "?t=" + wallpaperTimestamp : ""
        ...
        Connections {
            ...
            function onScreenChanged() {
                wallpaperBackground.updateWallpaperPath();
            }
        }
        ...
        Connections {
            ...
            function onLockscreenFrameReady() {
                wallpaperBackground.wallpaperTimestamp = Date.now();
                wallpaperBackground.updateWallpaperPath();
            }
        }
