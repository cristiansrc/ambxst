...
Item {
    ...
    component StyledSwitch: Switch {
        ...
        indicator: Rectangle {
            implicitWidth: 40
            implicitHeight: 20
            x: styledSwitchRoot.leftPadding
            y: styledSwitchRoot.height / 2 - height / 2
            radius: height / 2
            color: styledSwitchRoot.checked ? Styling.srItem("overprimary") : Colors.surfaceBright
            border.color: styledSwitchRoot.checked ? Styling.srItem("overprimary") : Colors.outline
            ...
            Rectangle {
                x: styledSwitchRoot.checked ? parent.width - width - 2 : 2
                y: 2
                width: parent.height - 4
                height: width
                radius: width / 2
                color: styledSwitchRoot.checked ? Colors.background : Colors.overSurfaceVariant
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            // Change Interval and other settings
                            ColumnLayout {
                                Layout.fillWidth: true
                                spacing: 8
                                ...
                                RowLayout {
                                    ...
                                    StyledRect {
                                        ...
                                        TextInput {
                                            ...
                                            text: wallpaperConfig.adapter.changeInterval.toString()

                                            onEditingFinished: {
                                                var val = parseInt(text);
                                                if (!isNaN(val) && val >= 5) {
                                                    if (wallpaperConfig.adapter.changeInterval !== val) {
                                                        wallpaperConfig.adapter.changeInterval = val;
                                                        wallpaperConfig.writeAdapter();
                                                    }
                                                }
                                            }
                                ...
                                RowLayout {
                                    ...
                                    StyledSwitch {
                                        checked: wallpaperConfig.adapter.randomMode
                                        onCheckedChanged: {
                                            if (checked !== wallpaperConfig.adapter.randomMode) {
                                                wallpaperConfig.adapter.randomMode = checked;
                                                wallpaperConfig.writeAdapter();
                                            }
                                        }
                                    }
                                ...
                                // Random Video Only toggle
                                RowLayout {
                                    Layout.fillWidth: true
                                    spacing: 8

                                    Text {
                                        text: "Random Videos Only"
                                        font.family: Config.theme.font
                                        font.pixelSize: Styling.fontSize(0)
                                        color: Colors.overBackground
                                        Layout.fillWidth: true
                                    ...
                                    StyledSwitch {
                                        checked: wallpaperConfig.adapter.randomVideoOnly
                                        onCheckedChanged: {
                                            if (checked !== wallpaperConfig.adapter.randomVideoOnly) {
                                                wallpaperConfig.adapter.randomVideoOnly = checked;
                                                wallpaperConfig.writeAdapter();
                                            }
                                        }
                                    }
