    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                // Unified container for Calendar/Toggles and Notifications
                StyledRect {
                    id: unifiedContainer
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    ...
                    TintedWallpaper {
                        ...
                        property double wallpaperTimestamp: Date.now()

                        function updateWallpaperPath() {
                            ...
                            activeWallpaperPath = GlobalStates.wallpaperManager.getLockscreenFramePath(baseWall);
                        }

                        source: activeWallpaperPath ? "file://" + activeWallpaperPath + "?t=" + wallpaperTimestamp : ""
                        opacity: activeWallpaperPath !== "" ? 1.0 : 0.0

                        Component.onCompleted: updateWallpaperPath()

                        Connections {
                            target: root
                            ignoreUnknownSignals: true
                            function onScreenNameChanged() {
                                unifiedBgArt.updateWallpaperPath();
                            }
                        }
                        ...
                        Connections {
                            ...
                            function onPerScreenWallpapersChanged() {
                                unifiedBgArt.updateWallpaperPath();
                            }
                            function onLockscreenFrameReady() {
                                unifiedBgArt.wallpaperTimestamp = Date.now();
                                unifiedBgArt.updateWallpaperPath();
                            }
                        }
                    ...
                    RowLayout {
                        ...
                        // Column 2 (Toggles + Calendar)
                        Item {
                            id: calendarColumnContainer
                ...
                ColumnLayout {
                    ...
                    Layout.fillHeight: true
                    spacing: 8
                    visible: brightnessContainer.visible
