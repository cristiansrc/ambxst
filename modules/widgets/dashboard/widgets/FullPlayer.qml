...
StyledRect {
    ...
    readonly property string artworkSource: {
        let activeP = MprisController.activePlayer;
        if (!activeP) return "file:///home/cristiansrc/Imágenes/Wallpapers/wallpaperbetter.com_2560x1440.jpg";
        let art = activeP.trackArtUrl ?? "";
        if (art !== "") return art;
        let url = "";
        if (activeP.metadata && activeP.metadata["xesam:url"]) {
            url = activeP.metadata["xesam:url"].toString();
        }
        if (url !== "") {
    ...
    property bool hasArtwork: artworkSource !== "file:///home/cristiansrc/Imágenes/Wallpapers/wallpaperbetter.com_2560x1440.jpg"
    property string wallpaperPath: artworkSource
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Item {
                id: titleContainer
                Layout.fillWidth: true
                Layout.preferredHeight: mediaTitle.implicitHeight
                clip: true
                ...
                Text {
                    ...
                    text: shouldScroll ? (dummyTitle.text + "   -   " + dummyTitle.text + "   -   ") : dummyTitle.text
                    color: Colors.overBackground
                    font.pixelSize: Config.theme.fontSize + 2
                    font.weight: Font.Bold
                    font.family: Config.theme.font

                    readonly property bool shouldScroll: dummyTitle.implicitWidth > titleContainer.width
                    readonly property real containerWidth: titleContainer.width
                    readonly property real oneLoopWidth: implicitWidth / 2
                    ...
                    function updatePosition() {
                        ...
                        if (shouldScroll) {
                            ...
                            x = Math.max(0, (containerWidth - implicitWidth) / 2);
                        }
                    }

                    onTextChanged: updatePosition()
                    onImplicitWidthChanged: updatePosition()
                    onContainerWidthChanged: updatePosition()
                    ...
                    SequentialAnimation {
                        ...
                        NumberAnimation {
                            ...
                            property: "x"
                            from: 0
                            to: -mediaTitle.oneLoopWidth
                            duration: mediaTitle.oneLoopWidth * 30
