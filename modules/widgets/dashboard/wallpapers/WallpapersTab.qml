...
FocusScope {
    ...
    ColumnLayout {
        ...
        // Barra superior con OLED mode y scheme selector
        RowLayout {
            ...
            SegmentedSwitch {
                ...
                options: [
                    { label: "Claro", icon: Icons.sun },
                    { label: "Oscuro", icon: Icons.moon },
                    { label: "Auto", icon: Icons.clock }
                ]
                ...
                onIndexChanged: index => {
                    if (index === 0) {
                        Config.theme.autoTheme = false;
                        Config.theme.lightMode = true;
                    } else if (index === 1) {
                        Config.theme.autoTheme = false;
                        Config.theme.lightMode = false;
                    } else if (index === 2) {
                        Config.theme.autoTheme = true;
                        Config.updateAutoTheme();
                    }
                }
            }

            // Selector de hora para Claro
            ComboBox {
                id: lightHourCombo
                ...
                currentIndex: model.indexOf(Config.theme.lightThemeStart)
                enabled: Config.theme.autoTheme
                opacity: enabled ? 1.0 : 0.5
                
                onActivated: index => {
                    Config.theme.lightThemeStart = model[index];
                }

                background: Rectangle {
                    color: lightHourCombo.hovered && lightHourCombo.enabled ? Colors.surfaceContainerHigh : Colors.surfaceContainer
                ...
                contentItem: Text {
                    text: lightHourCombo.currentText
                ...
                indicator: Text {
                    x: lightHourCombo.width - width - 10
                ...
                popup: Popup {
                    y: lightHourCombo.height + 4
                    width: lightHourCombo.width
                    ...
                    contentItem: ListView {
                        ...
                        model: lightHourCombo.delegateModel
                        currentIndex: lightHourCombo.highlightedIndex
                ...
                delegate: ItemDelegate {
                    ...
                    height: 32
                    background: Rectangle {
                        color: lightDel.highlighted ? Colors.surfaceContainerHigh : "transparent"
                        radius: Styling.radius(-2)
                    }
                    contentItem: Text {
                        text: modelData
            ...
            ComboBox {
                ...
                Layout.alignment: Qt.AlignVCenter
                model: ["00:00", "01:00", "02:00", "03:00", "04:00", "05:00", "06:00", "07:00", "08:00", "09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00", "23:00"]
                currentIndex: model.indexOf(Config.theme.darkThemeStart)
                enabled: Config.theme.autoTheme
                opacity: enabled ? 1.0 : 0.5
                
                onActivated: index => {
                    Config.theme.darkThemeStart = model[index];
                }

                background: Rectangle {
                    color: darkHourCombo.hovered && darkHourCombo.enabled ? Colors.surfaceContainerHigh : Colors.surfaceContainer
                    radius: Styling.radius(-2)
                    border.color: Colors.outlineVariant
                    border.width: 1
                }
                ...
                contentItem: Text {
                    text: darkHourCombo.currentText
                    font.family: Styling.defaultFont
                    font.pixelSize: Styling.fontSize(0)
                    color: Colors.overBackground
                    verticalAlignment: Text.AlignVCenter
                ...
                indicator: Text {
                    x: darkHourCombo.width - width - 10
                    anchors.verticalCenter: parent.verticalCenter
                    text: Icons.caretDown
                    font.family: Icons.font
                    font.pixelSize: 18
                ...
                popup: Popup {
                    y: darkHourCombo.height + 4
                    width: darkHourCombo.width
                    implicitHeight: Math.min(contentItem.contentHeight, 200)
                    padding: 4
                    ...
                    contentItem: ListView {
                        clip: true
                        implicitHeight: contentHeight
                        model: darkHourCombo.delegateModel
                        currentIndex: darkHourCombo.highlightedIndex
                        ScrollIndicator.vertical: ScrollIndicator {}
                    }
                }
                ...
                delegate: ItemDelegate {
                    ...
                    height: 32
                    background: Rectangle {
                        color: darkDel.highlighted ? Colors.surfaceContainerHigh : "transparent"
                        radius: Styling.radius(-2)
                    }
                    contentItem: Text {
                        text: modelData
        ...
        // Segunda fila con el campo de búsqueda (izquierda) y filtros (derecha)
        RowLayout {
            Layout.fillWidth: true
            Layout.preferredHeight: 48
            spacing: 16
            ...
            SearchInput {
                ...
                Layout.alignment: Qt.AlignVCenter
                text: searchText
                placeholderText: "Buscar fondos de pantalla..."
                iconText: ""
                clearOnEscape: false
