...
Item {
    ...
    readonly property string artworkSource: {
        if (!player) return "file:///home/cristiansrc/Imágenes/Wallpapers/wallpaperbetter.com_2560x1440.jpg";
    ...
    StyledRect {
        ...
        Item {
            ...
            Text {
                ...
                text: shouldScroll ? (compactPlayer.displayedTitle + "   -   " + compactPlayer.displayedTitle + "   -   ") : compactPlayer.displayedTitle
                font.family: Config.theme.font
                font.pixelSize: Styling.fontSize(0)
                font.bold: true
                color: Colors.overBackground

                readonly property bool shouldScroll: dummyTitle.implicitWidth > textContainer.width
                readonly property real containerWidth: textContainer.width
