...
FloatingWindow {
    ...
    screen: screenByName(GlobalStates.settingsTargetScreenName || AxctlService.focusedMonitor?.name || "")
    ...
    function preparePlacement() {
        console.log("[SettingsWindow] preparePlacement called. Target Screen Name:", GlobalStates.settingsTargetScreenName);
        const targetScreen = screenByName(GlobalStates.settingsTargetScreenName || AxctlService.focusedMonitor?.name || "");
        console.log("[SettingsWindow] resolved targetScreen:", targetScreen ? targetScreen.name : "null");
    ...
    function placeOnTargetWorkspace() {
        ...
        console.log("[SettingsWindow] placeOnTargetWorkspace. Target Workspace:", targetWorkspace);
