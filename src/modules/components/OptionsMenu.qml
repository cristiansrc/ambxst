...
Menu {
    ...
    Instantiator {
        ...
        delegate: MenuItem {
            ...
            onTriggered: {
                console.log("[OptionsMenu Debug] MenuItem triggered. Index:", itemIndex, "Text:", text);
                console.log("[OptionsMenu Debug] itemData:", JSON.stringify(itemData));
                if (itemData) {
                    console.log("[OptionsMenu Debug] itemData.onTriggered type:", typeof itemData.onTriggered);
                }
                if (itemData && itemData.onTriggered) {
                    let callback = itemData.onTriggered;
                    console.log("[OptionsMenu Debug] Executing callback via Qt.callLater...");
                    Qt.callLater(callback);
                } else {
                    console.log("[OptionsMenu Debug] No onTriggered callback found or itemData is null");
                }
            }
        }
